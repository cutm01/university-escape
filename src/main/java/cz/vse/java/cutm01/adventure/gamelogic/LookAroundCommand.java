...
class LookAroundCommand implements Command {
  ...
  public String executeCommand(String... commandParameters) {
    ...
    String itemNames = (actualRoom.getNumberOfItemsInRoom() > 0) ? actualRoom.getItemNames() : null;
    String objectNames =
    ...
    String characterNames =
        (actualRoom.getNumberOfNonPlayerCharactersInRoom() > 0)
            ...
            : null;
    String exits =
        (actualRoom.getNeighboringRooms().size() > 0) ? actualRoom.getNeighboringRoomNames() : null;

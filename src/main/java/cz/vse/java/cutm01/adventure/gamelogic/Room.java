 ...
 *
 * <p>"Room" reprezentuje jedno místo (místnost, prostor, ..) ve scénáři hry. Room může mít sousední
...
class Room {
  ...
  /**
   * Method return names of all items inside the room which player can take<br>
   * Names of items are returned as one String, where each one is separated by comma
   *
  ...
  /**
   * Method return names of all interactable object inside the room which player can use<br>
   * Names of objects are returned as one String, where each one is separated by comma
   *

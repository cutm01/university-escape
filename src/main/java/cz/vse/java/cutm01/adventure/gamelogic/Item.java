...
/**
 * Item class represents game items which player can discover<br>
 * Player can take them and use them to perform special action later in game, they can contain
 * hidden items which player can find by performing ExecuteItem command
 *

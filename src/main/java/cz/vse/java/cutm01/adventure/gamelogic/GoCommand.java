...
class GoCommand implements Command {
  ...
  /**
   * Provádí příkaz "jdi". Zkouší se vyjít do zadaného prostoru. Pokud prostor existuje, vstoupí se
   * do nového prostoru. Pokud zadaný sousední prostor (východ) není, vypíše se chybové hlášení.
   *

...
public enum NonPlayerCharacterSpeech {
    CLEANING_LADY("Pokúšaš sa prihovoriť upratovačke, ale tá ťa cez sluchátka, z ktorých jej hrá Dlouhá noc od Helenky Vondráčkovej vôbec nepočuje"),
    COUGHING_TEACHER("Učiteľ neprestajne kašle, je to z toho prachu po výbuchu alebo má nejaké respiračné problémy? Každopádne si s ním asi veľmi nepokecáš"),
    IT_ADMIN("Snažíš sa IT adminovi vysvetliť čo sa pred chvíľou stalo, ale ten stále rozpráva niečo o nejakej knihe, že by ju chcel priniesť?"),
    DOOR_KEEPER("Vrátnik stále rozpráva o tom, že chce vidieť tvoje doklady, inak ťa nepustí von. Z čoho je taký podráždený?");

...
public class GameImpl implements Game {
  ...
  /**
   * Method returns game ending text which varies according to decision which player made during the
   * game
   *
  ...
  public String getGameEnding() {
    ...
    if (gamePlan.getPlayer().getHasPlayerEscapedUsingWindow()) {
      gameEnding
          .append("Všetci so zatajeným dychom pozorujú ako sa zlaňuješ z okna Starej budovy\n")
          .append("Gratulujem, úspešne sa ti podarilo dostať von!\n");
    }

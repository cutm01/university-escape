 ...
 * in actual game room in more detail.<br>
...
class ExamineObjectCommand implements Command {
   ...
   * Interactable object has to be in actual room and player has to stand nearby<br>
  ...
  public String executeCommand(String... commandParameters) {
    ...
    boolean wasObjectAlreadyExamined = objectToExamine.getWasInteractableObjectAlreadyExamined();

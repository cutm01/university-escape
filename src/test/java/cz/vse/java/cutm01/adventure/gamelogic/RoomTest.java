...
class RoomTest {
  ...
  private static Stream<Arguments> provideRoomInstancesWithTheirCorrespondingEnumConstant() {
    return Stream.of(
        ...
        Arguments.of(
            new Room(RoomName.DRESSING_ROOM.toString(), false), RoomName.DRESSING_ROOM.toString()),
        Arguments.of(
            new Room(RoomName.NEW_BUILDING.toString(), false), RoomName.NEW_BUILDING.toString()),
        Arguments.of(
            new Room(RoomName.OLD_BUILDING.toString(), false), RoomName.OLD_BUILDING.toString()),
        Arguments.of(new Room(RoomName.LIBRARY.toString(), false), RoomName.LIBRARY.toString()),
        Arguments.of(new Room(RoomName.COURTYARD.toString(), false), RoomName.COURTYARD.toString()),
        Arguments.of(
            new Room(RoomName.LECTURE_ROOM.toString(), false), RoomName.LECTURE_ROOM.toString()),
